...
let test_eval_poly () =
  ...
  let x0 = 0 in
  assert(eval_poly x0 poly = (fromInt 1234));
  let x1 = 1 in
  assert(eval_poly x1 poly = (fromInt 1494));
  let x2 = 2 in
  assert(eval_poly x2 poly = (fromInt 1942));
  let x3 = 3 in 
  assert(eval_poly x3 poly = (fromInt 2578));
  let poly2 = [(fromInt 500); (fromInt (-10)); (fromInt 5)] in
  assert(eval_poly x0 poly2 = (fromInt 500));
  assert(eval_poly x1 poly2 = (fromInt 495));
  assert(eval_poly x2 poly2 = (fromInt 500));
  assert(eval_poly x3 poly2 = (fromInt 515))
;;
